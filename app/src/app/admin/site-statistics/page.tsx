      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-6 space-y-6">
          {stats.map((stat) => (
            <div
              key={stat.key}
              className="flex flex-col sm:flex-row sm:items-center gap-4 pb-6 border-b border-gray-100 last:border-0 last:pb-0"
            >
              <div className="flex-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setValues((v) => ({ ...v, [stat.key]: parseInt(e.target.value, 10) || 0 }))
                  }
